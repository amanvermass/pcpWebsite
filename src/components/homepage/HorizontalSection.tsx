  ...
  return (
    <section ref={targetRef} id="featured-gallery" className="relative h-[400vh] bg-brand-black">
      ...
      <div className="sticky top-0 h-screen overflow-hidden flex items-center">
        ...
        {/* Top left section descriptor */}
        <div className="absolute top-10 left-12 z-10 hidden md:block">
          <span className="text-[10px] font-poppins tracking-[0.45em] uppercase text-brand-gold/60">
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center text-left">
                ...
                <p className="text-xs sm:text-sm font-poppins text-brand-sand/75 leading-relaxed max-w-xl mb-6">
                  {project.desc}
                </p>

                {/* Info grids */}
                <div className="grid grid-cols-2 gap-y-3 gap-x-4 border-t border-brand-gold/10 pt-6 max-w-md">
                  <div className="flex items-center gap-2 text-xs font-poppins text-brand-sand/80">
                  ...
                  <div className="flex items-center gap-2 text-xs font-poppins text-brand-sand/80 col-span-2">
                ...
                <div className="mt-8">
                  <Magnetic>
                    <Link
                      ...
                      className="inline-flex items-center gap-2 bg-brand-gold/10 hover:bg-brand-gold text-brand-gold hover:text-brand-black px-6 py-3 border border-brand-gold/30 hover:border-brand-gold tracking-widest uppercase text-[10px] font-poppins transition-colors cursor-none"
                    >
                      View Case Study
